...
echo "$($PSQL "SELECT name FROM teams FULL JOIN games ON team_id=winner_id WHERE (year=2014 AND round='Eighth-Final') UNION SELECT name FROM teams FULL JOIN games ON team_id=opponent_id WHERE (year=2014 AND round='Eighth-Final') ORDER BY name")"
